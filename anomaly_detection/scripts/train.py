...
def transform_infer(df):
    ...
    with open(os.path.join(os.path.dirname(os.getcwd()), 'anomaly_detection/feature_store/feature_set.json'), 'r') as feature:
...
def train_and_infer(df, classification="Binary"):
    ...
    with open(os.path.join(os.path.dirname(os.getcwd()), 'anomaly_detection/feature_store/feature_set.json'), 'w') as feature:
